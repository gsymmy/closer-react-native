...
export default class Home extends React.Component {
  ...
  return (
    ...
    <SafeAreaView style={{backgroundColor: colors.appSecondary}} />
      ...
      <View style={{backgroundColor: colors.appSecondary, marginTop: 20, borderRadius: 10}}>
      ...
      <View style={styles.footer}>
        ...
        <FooterTab title='Family' count={this.state.watchingCount}>
        <Ionicons name='ios-contacts' style={{fontSize: 35, color: colors.appText}}/>
        </FooterTab>
        <FooterTab title='Engage' count={this.state.watchedCount}>
